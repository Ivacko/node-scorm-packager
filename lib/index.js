...
var buildPackage = function(obj, callback) {
  ...
  switch (obj.version) {
    case '1.2':
      ...
      definitionFiles = path.join('lib', 'schemas', 'definitionFiles', 'scorm12edition');
      break;
    case '2004 3rd Edition':
      schemaVersion = 'scorm2004';
      definitionFiles = path.join('lib', 'schemas', 'definitionFiles', 'scorm20043rdedition');
      break;
    case '2004 4th Edition':
      schemaVersion = 'scorm2004';
      definitionFiles = path.join('lib', 'schemas', 'definitionFiles', 'scorm20044thedition');
      break;
  }

  if (!schemaVersion) {
    callback('Supported are only:\n1.2\n2004 3rd Edition\n2004 4th Edition');
    return;
  }
